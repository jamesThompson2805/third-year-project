\chapter{Bone Image data sets -\/ Distal\+Phalanx\+Outline\+Age\+Group}
\hypertarget{md_external_2data_2UCRArchive__2018_2DistalPhalanxOutlineAgeGroup_2README}{}\label{md_external_2data_2UCRArchive__2018_2DistalPhalanxOutlineAgeGroup_2README}\index{Bone Image data sets -\/ DistalPhalanxOutlineAgeGroup@{Bone Image data sets -\/ DistalPhalanxOutlineAgeGroup}}
\label{md_external_2data_2UCRArchive__2018_2DistalPhalanxOutlineAgeGroup_2README_autotoc_md42}%
\Hypertarget{md_external_2data_2UCRArchive__2018_2DistalPhalanxOutlineAgeGroup_2README_autotoc_md42}%
 The data set is in the series of 10 classification problems created as part of Luke Davis\textquotesingle{}s PhD thesis (see \mbox{[}1\mbox{]}, \mbox{[}2\mbox{]}). They are all derived from the same images from Cao et al. (see \mbox{[}3\mbox{]}). The data sets are designed to test the efficacy of hand and bone outline detection and whether these outlines could be helpful in bone age prediction.
