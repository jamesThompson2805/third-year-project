...
vector< tuple< double, unsigned int>> exact_dp::exact_paa( const vector<double>& s, unsigned int num_params)
{
...
vector< tuple< DoublePair, unsigned int>> exact_dp::exact_pla( const vector<double>& s, unsigned int num_params)
{
